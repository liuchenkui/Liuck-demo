    ...
    <div class="confirm-content">
      ...
      <div class="confirm-goods">
        ...
        <div class="goods-list">
          <ul>
            <li
              v-for="item in $store.state.cartList.filter((item) => item.check)"
            >
      ...
      <div class="section-bar">
        <div class="btn">
          <button class="btn-base btn-return" @click="$router.push('/cart')">返回购物车</button>
...
export default {
  ...
  methods: {
    settlement(){
        this.$axios.post('/user/order/addOrder',{user_id:this.$store.state.user.user_id,products:this.$store.state.cartList.filter((item) => item.check)}).then(res => {
            // console.log(res);
